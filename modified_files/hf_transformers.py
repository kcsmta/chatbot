...
class HFTransformersNLP(Component):
    ...
    def __init__(self, component_config: Optional[Dict[Text, Any]] = None) -> None:
        ...
        self.bpe = fastBPE.fastBPE(
            '/home/khanh/Desktop/projects/MeeylandChatbot/test_bert/PhoBERT_base_transformers/bpe.codes',
            "/home/khanh/Desktop/projects/MeeylandChatbot/test_bert/PhoBERT_base_transformers/dict.txt")

        # Load the dictionary
        self.vocab = Dictionary()
        self.vocab.add_from_file("/home/khanh/Desktop/projects/MeeylandChatbot/test_bert/PhoBERT_base_transformers/dict.txt")
    ...
    def _load_model(self) -> None:
        ...
        if self.model_weights == 'phoBert':
            ...
            config = RobertaConfig.from_pretrained(
                "/home/khanh/Desktop/projects/MeeylandChatbot/test_bert/PhoBERT_base_transformers/config.json"
            )
            self.model = RobertaModel.from_pretrained(
                "/home/khanh/Desktop/projects/MeeylandChatbot/test_bert/PhoBERT_base_transformers/model.bin",
                config=config,
                cache_dir=self.cache_dir
            )
            # self.tokenizer = RobertaTokenizer(
            #     vocab_file = "/home/khanh/Desktop/projects/MeeylandChatbot/test_bert/PhoBERT_base_transformers/dict.txt",
            #     merges_file='/home/khanh/Desktop/projects/MeeylandChatbot/test_bert/PhoBERT_base_transformers/roberta-base-merges.txt',
            ...
            #                     default="/home/khanh/Desktop/projects/MeeylandChatbot/test_bert/PhoBERT_base_transformers/bpe.codes",
            #                     required=False,
            #                     type=str,
    ...
    def _lm_tokenize(self, text: Text) -> Tuple[List[int], List[Text]]:
        ...
        if self.model_weights == 'phoBert':
            ...
            text_ = '<s> ' + self.bpe.apply([text])[0] + ' </s>'
            split_token_strings = text_.split()

            # Map subword tokens to corresponding indices in the dictionary
            split_token_ids = self.vocab.encode_line(text_, append_eos=False, add_if_not_exist=False).long().tolist()
            split_token_ids = torch.tensor(split_token_ids)
        else:
